  ...
  return (
    <div className="space-y-2 w-full max-w-md">
      <div className="flex items-center gap-2">
        ...
        <span className="text-xs text-gray-500">You: {playerId ?? "..."}</span>
      </div>
          ...
          return (
            <li key={g._id} className="p-2 flex flex-col gap-1 text-sm">
              ...
              <div className="flex justify-between text-xs text-gray-600">
                <span>P1: {g.player1.slice(0, 8)}{youAreP1 && " (you)"}</span>
                <span>P2: {g.player2 ? g.player2.slice(0, 8) + (youAreP2 ? " (you)" : "") : canJoin ? (
                  <button
